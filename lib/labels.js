...
// What a volunteer took on for one specific request. Distinct from the
// can_bake/can_buy/can_deliver flags on their profile, which say what
// they're willing to do in general.
export const CLAIM_ROLE_OPTIONS = [
  ["both", "Make/buy it and deliver it"],
  ["make", "Make or buy it only"],
  ["deliver", "Deliver it only"],
];

const CLAIM_ROLE_LABELS = Object.fromEntries(CLAIM_ROLE_OPTIONS);

export function claimRoleLabel(value) {
