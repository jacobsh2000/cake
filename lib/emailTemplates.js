...
export function cancellationEmailHtml(reqRow, reason) {
  return `
    <p>Request ${reqRow.request_number} — ${reqRow.recipient_first_name}, age ${reqRow.recipient_age},
    needed by ${formatDateTime(reqRow.requested_datetime)} — has been cancelled.</p>
    <p><strong>Reason:</strong> ${reason}</p>
    <p>There's nothing you need to do. Please don't contact the family about this request.
    If you'd already started baking or bought ingredients, reply to this email and let Emily know.</p>
    <p>Thank you for volunteering — please do take another request from the board when you're ready.</p>
  `;
}
